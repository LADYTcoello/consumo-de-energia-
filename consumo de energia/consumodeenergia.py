...
def menu():
    ...
    print('<3> TOTAL RECAUDADO POR CADA REGION')
    print('<4> SALIR')
    ...
    if ops == 1 :
      ...
      while op !=2:
        ...
        if c == 'QUITO':
            ...
            break
             ...
             print('¡CIUDAD NO CONSTA EN EL SISTEMA!')
     ...
     while op!=4:
        ...
        if r == 'SIERRA':
              ...
              print('INGRESOS DE LA REGION SIERRA:', '$',((q_c_a*q_t_a) + (q_c_b*q_t_b)) + (l_c_a*l_t_a))
              break
        elif r == 'COSTA':
             ...
             print('INGRESOS DE LA REGION COSTA:',((g_c_a * g_t_a) + (g_c_b * g_t_b)))
             break
        else :
            print('REGION ASIGNADA NO CONSTA EN EL SISTEMA.')
